...
## [0.1.2](https://github.com/stellar-registry/cli/compare/stellar-registry-cli-v0.1.1...stellar-registry-cli-v0.1.2) - 2026-09-25

### Other

- *(deps)* bump crate-git-revision from 0.0.6 to 0.0.9 ([#2](https://github.com/stellar-registry/cli/pull/2))
